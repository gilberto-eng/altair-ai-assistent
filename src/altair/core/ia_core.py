...
class IALocal:
        ...
        self.respostas = {
            "saudacao": {
                ...
                "ironico": [
                    ...
                    "Bem vindo de volta chefe, senti sua falta."
                ]
            },
    ...
    def perguntar(self, comando, permitir_automacao=True, forcar_modelo_grande=None):
        ...
        if "que ano estamos" in comando or "qual o ano atual" in comando or "em que ano estamos" in comando or "ano atual" in comando:
          agora = datetime.datetime.now()
        ...
        if "adicionar frase" in comando:
            palavras = comando.split()
            remover = "adicionar frase"
            palavras_filtradas = [p for p in palavras if p.lower() not in remover]
            frase_final = "".join(palavras_filtradas)
