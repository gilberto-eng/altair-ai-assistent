...
class PiperVoice:
    def __init__(
        ...
        self.modo_pro = bool(modo_pro)
        if self.modo_pro and not self.ffmpeg_path:
            print("Aviso: FFmpeg nao encontrado. Desativando modo_pro para manter a voz funcionando.")
            self.modo_pro = False
    ...
    def speak(self, texto):
        ...
        try:
            ...
            print("Erro na sintese de voz:", e)
    ...
    # ==========================================================
    # SAVE TO FILE (USADO PELO WHATSAPP)
    # ==========================================================
    ...
    def save_to_file(self, texto, caminho_arquivo):
        ...
        try:
            ...
            if not os.path.exists(caminho_arquivo):
                print("WAV nao foi criado.")
                return None

            print("Audio salvo em:", caminho_arquivo)
...
class ElevenLabsVoice:
    ...
    def save_to_file(self, texto, caminho_arquivo):
        ...
        try:
            ...
            if not ffmpeg_cmd:
                print("Erro ElevenLabs: FFmpeg nao encontrado para converter MP3.")
                return None
            cmd = [ffmpeg_cmd, "-y", "-i", temp_mp3, caminho_arquivo]
